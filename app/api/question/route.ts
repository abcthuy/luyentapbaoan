...
`;
                ...
                if (!jsonMatch) {
                    console.error('LLM question output does not contain JSON:', rawText);
                ...
                try {
                    ...
                    console.error('JSON parse failed for question:', jsonMatch[0]);
                ...
                const issues = validateQuestion(normalizedQuestion, { 
